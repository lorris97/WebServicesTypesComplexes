 ...
 * generated in the teamsClient package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetTeam_QNAME = new QName("http://team.demowebservice.objis.com/", "getTeam");
    private final static QName _GetTeamResponse_QNAME = new QName("http://team.demowebservice.objis.com/", "getTeamResponse");
    private final static QName _GetTeamsResponse_QNAME = new QName("http://team.demowebservice.objis.com/", "getTeamsResponse");
    private final static QName _GetTeams_QNAME = new QName("http://team.demowebservice.objis.com/", "getTeams");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: teamsClient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://team.demowebservice.objis.com/", name = "getTeam")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://team.demowebservice.objis.com/", name = "getTeamResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://team.demowebservice.objis.com/", name = "getTeamsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://team.demowebservice.objis.com/", name = "getTeams")
