 ...
 * 
 */
@WebServiceClient(name = "TeamsService", targetNamespace = "http://team.demowebservice.objis.com/", wsdlLocation = "http://localhost:8888/teams?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TEAMSSERVICE_QNAME = new QName("http://team.demowebservice.objis.com/", "TeamsService");
    ...
    public Teams getTeamsPort() {
        return super.getPort(new QName("http://team.demowebservice.objis.com/", "TeamsPort"), Teams.class);
    }
    ...
    public Teams getTeamsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://team.demowebservice.objis.com/", "TeamsPort"), Teams.class, features);
    }
